...
# Engine kernels via muimage / muraw.engines.core._engine_load.
#
...
def supported_xmp_from_dict(props: dict[str, Any]) -> 'XmpMetadata':
    ...
    attributes['xmp:CreatorTool'] = 'muraw'
...
def add_supported_xmp_from_dict(metadata_tags: 'MetadataTags', props: dict[str, Any]) -> None:
    ...
    Example:
        muraw.add_supported_xmp_from_dict(camera_metadata, {
            'Temperature': 5800,
            'Tint': 0,
            'Exposure2012': -0.5,
