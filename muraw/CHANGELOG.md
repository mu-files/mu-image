...
### Added
- **Performance Timing**: Comprehensive hierarchical timing of DNG rendering pipeline. Run `muraw dng convert -v` to get a per-step breakdown (decode, linearize, color transforms, tone curves, etc.) with milliseconds and percentage of total render time.
