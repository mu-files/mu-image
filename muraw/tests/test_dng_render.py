...
from muraw.dngio import DngFile, decode_dng
...
# Format: (file_stem, muraw_ps_thresh, ci_ps_thresh, muraw_dngval_thresh, ci_dngval_thresh)
...
TEST_CASES = [
    # Camera files
    ("asi676mc_1", 0.74, 1.23, 0.15, 1.57),  # PS: MURAW 0.67%, CI 1.12%; dngval: MURAW 0.14%, CI 1.43%
    ("canon_eos_r5_baselineexposure-bl1", 1.67, 1.80, 0.02, 0.39),  # PS: MURAW 1.52%, CI 1.93%; dngval: MURAW 0.02%, CI 0.35%
    ("canon_eos_r5_exposure", 1.80, 1.80, 0.02, 0.59),  # PS: MURAW 2.41%, CI 4.17%; dngval: MURAW 0.01%, CI 0.54%
    ("canon_eos_r5_none", 1.30, 1.79, 0.02, 0.59),  # PS: MURAW 1.18%, CI 1.74%; dngval: MURAW 0.01%, CI 0.54%
    ("canon_eos_r5_temp-tint", 1.30, 1.79, 0.02, 0.59),  # PS: MURAW 1.18%, CI 1.77%; dngval: MURAW 0.01%, CI 0.54%
    ("dc-s9_1", 1.64, 1.80, 0.03, 1.40),  # PS: MURAW 1.49%, CI 1.98%; dngval: MURAW 0.02%, CI 1.27%
    ("e-m10markiv_1", 1.80, 1.80, 0.01, 0.45),  # PS: MURAW 2.01%, CI 2.60%; dngval: MURAW 0.01%, CI 0.41%
    ("insta360_oners", 1.80, 1.80, 0.01, 0.54),  # PS: MURAW 2.36%, CI 2.23%; dngval: MURAW 0.01%, CI 0.49%
    ("iphone_15_pro_1_back_camera_lossy", 0.63, 1.08, 0.21, 0.87),  # PS: MURAW 0.57%, CI 0.98%; dngval: MURAW 0.19%, CI 0.79%
    ("iphone_15_pro_flowers", 1.80, 1.80, 0.23, 0.98),  # PS: MURAW 27.83%, CI 28.67%; dngval: MURAW 0.21%, CI 0.89%
    ("leica_sl2-s_1", 1.64, 1.62, 0.02, 0.34),  # PS: MURAW 1.49%, CI 1.47%; dngval: MURAW 0.01%, CI 0.31%
    ("nikon_z_8_1437", 1.53, 1.79, 0.02, 0.81),  # PS: MURAW 1.39%, CI 1.70%; dngval: MURAW 0.01%, CI 0.74%
    ("nikon_z_9", 1.79, 1.80, 0.03, 0.90),  # PS: MURAW 1.76%, CI 2.24%; dngval: MURAW 0.02%, CI 0.82%
    ("pentax_k-3_mark_iii_1", 1.61, 1.64, 0.25, 0.90),  # PS: MURAW 1.46%, CI 1.49%; dngval: MURAW 0.23%, CI 0.82%
    ("pixel_9_pro_fold_20240902_030456036", 1.80, 1.80, 1.80, 1.80),  # PS: MURAW 7.67%, CI 6.89%; dngval: MURAW 1.88%, CI 2.02%
    ("ricoh_gr_iiix_1", 1.24, 1.16, 0.21, 0.44),  # PS: MURAW 1.13%, CI 1.05%; dngval: MURAW 0.19%, CI 0.40%
    ("sony_dsc-rx100m7", 1.06, 1.08, 0.02, 0.55),  # PS: MURAW 0.96%, CI 0.98%; dngval: MURAW 0.01%, CI 0.50%
    ("sony_ilce-7c_lossy", 1.00, 1.56, 0.02, 0.68),  # PS: MURAW 0.91%, CI 1.42%; dngval: MURAW 0.02%, CI 0.62%
    # Test pattern files
    ("asi676mc_colorpattern_bcurve", 0.63, 1.80, 0.01, 1.45),  # PS: MURAW 0.57%, CI 1.82%; dngval: MURAW 0.00%, CI 1.32%
    ("asi676mc_colorpattern_exposure", 0.72, 1.13, 0.01, 1.45),  # PS: MURAW 0.65%, CI 1.03%; dngval: MURAW 0.00%, CI 1.32%
    ("asi676mc_colorpattern_gcurve", 0.73, 1.79, 0.01, 1.45),  # PS: MURAW 0.66%, CI 1.72%; dngval: MURAW 0.00%, CI 1.32%
    ("asi676mc_colorpattern_none", 0.77, 1.80, 0.01, 1.45),  # PS: MURAW 0.70%, CI 1.85%; dngval: MURAW 0.00%, CI 1.32%
    ("asi676mc_colorpattern_rcurve", 0.73, 1.64, 0.01, 1.45),  # PS: MURAW 0.66%, CI 1.49%; dngval: MURAW 0.00%, CI 1.32%
    ("asi676mc_colorpattern_temp-tint", 0.89, 1.80, 0.01, 1.45),  # PS: MURAW 0.81%, CI 1.85%; dngval: MURAW 0.00%, CI 1.32%
    ("asi676mc_curve", 1.46, 1.50, 0.01, 0.28),  # PS: MURAW 1.33%, CI 1.36%; dngval: MURAW 0.00%, CI 0.25%
    ("asi676mc_exposure", 0.78, 0.86, 0.01, 0.28),  # PS: MURAW 0.71%, CI 0.78%; dngval: MURAW 0.00%, CI 0.25%
    ("asi676mc_none", 1.23, 1.28, 0.01, 0.28),  # PS: MURAW 1.12%, CI 1.16%; dngval: MURAW 0.00%, CI 0.25%
    ("asi676mc_rgbcurve", 1.45, 1.47, 0.01, 0.28),  # PS: MURAW 1.32%, CI 1.34%; dngval: MURAW 0.00%, CI 0.25%
    ("linear_gradient_test_exp-curve", 1.80, 1.80, 0.01, 0.12),  # PS: MURAW 2.92%, CI 13.73%; dngval: MURAW 0.00%, CI 0.11%
    ("rgb_ramp_test", 1.80, 1.80, 0.02, 1.80),  # PS: MURAW 9.96%, CI 10.38%; dngval: MURAW 0.01%, CI 2.29%
    ("rgb_ramp_test_bcurve", 1.80, 1.80, 0.02, 1.80),  # PS: MURAW 11.72%, CI 12.47%; dngval: MURAW 0.01%, CI 2.29%
    ("rgb_ramp_test_bcurve2", 1.01, 1.80, 0.02, 1.80),  # PS: MURAW 0.92%, CI 3.43%; dngval: MURAW 0.01%, CI 2.29%
    ("rgb_ramp_test_gcurve", 0.74, 1.80, 0.02, 1.80),  # PS: MURAW 0.67%, CI 2.05%; dngval: MURAW 0.01%, CI 2.29%
    ("rgb_ramp_test_maincurve", 1.56, 1.80, 0.02, 1.80),  # PS: MURAW 1.42%, CI 2.34%; dngval: MURAW 0.01%, CI 2.29%
    ("rgb_ramp_test_mainrgbcurve", 1.26, 1.80, 0.02, 1.80),  # PS: MURAW 1.15%, CI 2.40%; dngval: MURAW 0.01%, CI 2.29%
    ("rgb_ramp_test_multi-curve", 1.52, 1.80, 0.02, 1.80),  # PS: MURAW 1.38%, CI 2.40%; dngval: MURAW 0.01%, CI 2.29%
    ("rgb_ramp_test_rcurve", 0.66, 1.79, 0.02, 1.80),  # PS: MURAW 0.60%, CI 1.68%; dngval: MURAW 0.01%, CI 2.29%
]


@pytest.mark.parametrize(
    "file_stem,muraw_ps_thresh,ci_ps_thresh,muraw_dngval_thresh,ci_dngval_thresh",
    TEST_CASES,
    ids=lambda x: x if isinstance(x, str) else None,
)
def test_muraw_vs_photoshop(
    file_stem, muraw_ps_thresh, ci_ps_thresh, muraw_dngval_thresh, ci_dngval_thresh,
    output_dir, request
):
    """Test MURAW rendering against Photoshop reference."""
    if muraw_ps_thresh is None:
        pytest.skip(f"MURAW vs Photoshop skipped for {file_stem} (shape mismatch or known issue)")
    
    threshold = muraw_ps_thresh
    if threshold >= 1.8:
        request.applymarker(pytest.mark.xfail(reason=f"MURAW vs Photoshop diff > 1.8%"))
    ...
    assert result is not None, f"MURAW rendering failed for {file_stem}"

    # Save rendered output
    tifffile.imwrite(str(output_dir / f"{file_stem}_muraw.tif"), result)
    ...
    if result.shape != ref.shape:
        pytest.fail(f"Shape mismatch: MURAW={result.shape}, Photoshop={ref.shape}")

    # Compare
    stats = compute_diff_stats(result, ref)
    measured_diff = stats['mean']

    print(f"\n  [MURAW vs PS] {file_stem}: diff={measured_diff:.2f}% (threshold={threshold}%)")

    if measured_diff >= threshold:
        pytest.fail(f"MURAW vs Photoshop: measured {measured_diff:.2f}% > threshold {threshold}%")
...
def test_muraw_vs_dng_validate(
    file_stem, muraw_ps_thresh, ci_ps_thresh, muraw_dngval_thresh, ci_dngval_thresh,
    output_dir, request
):
    """Test MURAW rendering against dng_validate reference."""
    if muraw_dngval_thresh is None:
        pytest.skip(f"MURAW vs dng_validate skipped for {file_stem} (shape mismatch or known issue)")
    
    threshold = muraw_dngval_thresh
    if threshold >= 1.8:
        request.applymarker(pytest.mark.xfail(reason=f"MURAW vs dng_validate diff > 1.8%"))
    ...
    # Render with MURAW (use_xmp=False, no highlight preservation)
    with DngFile(dng_path) as dng:
        muraw_result = dng.render_raw(
            output_dtype=np.uint16,
            demosaic_algorithm=DemosaicAlgorithm.BILINEAR,
            strict=False,
            use_xmp=False,
    ...
    assert muraw_result is not None, f"MURAW rendering failed for {file_stem}"
    ...
    # Ensure same shape
    if muraw_result.shape != dngval_result.shape:
        pytest.fail(f"Shape mismatch: MURAW={muraw_result.shape}, dng_validate={dngval_result.shape}")

    # Compare
    stats = compute_diff_stats(muraw_result, dngval_result)
    measured_diff = stats['mean']

    print(f"\n  [MURAW vs dngval] {file_stem}: diff={measured_diff:.2f}% (threshold={threshold}%)")

    if measured_diff >= threshold:
        pytest.fail(f"MURAW vs dng_validate: measured {measured_diff:.2f}% > threshold {threshold}%")
