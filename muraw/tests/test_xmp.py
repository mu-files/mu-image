...
from muraw.dngio import DngFile, IfdDataSpec, write_dng_from_array
from muraw.tiff_metadata import MetadataTags, XmpMetadata
from muraw.raw_render import supported_xmp_from_dict, supported_xmp_to_dict, add_supported_xmp_from_dict
...
def test_xmp_roundtrip_dng_file():
    ...
    with DngFile(dng_path) as dng:
        ...
        from muraw.tiff_metadata import xmp_metadata_to_packet
