...
FLOAT16_LINEAR_RAW_CONFIGS = [
    ("uncompressed", None, 0.0, 0.0, 0.32, 9.06, 1.0),
    ("lossless_jxl", 0.0, 0.06, 1.11, 0.33, 9.06, 0.3545),
...
UINT16_LINEAR_RAW_CONFIGS = [
    ("uncompressed", None, 0.0, 0.0, 0.32, 9.06, 1.0),
    ("lossless_jxl", 0.0, 0.06, 1.11, 0.33, 9.06, 0.3546),
...
UINT16_CFA_CONFIGS = [
    ("uncompressed", None, 0.0, 0.0, 0.77, 32.35, 1.0),
    ("lossless_jxl", 0.0, 0.01, 0.08, 0.77, 32.35, 0.4766),
...
UINT8_LINEAR_RAW_CONFIGS = [
    ...
    ("lossless_jxl", 0.0, 0.06, 4.74, 0.37, 23.73, 0.7602),
...
UINT8_CFA_CONFIGS = [
    ...
    ("lossless_jxl", 0.0, 0.09, 12.93, 0.89, 31.92, 0.9897),
...
UINT16_10BIT_CFA_CONFIGS = [
    ...
    ("lossless_jxl", 0.0, 0.01, 0.08, 0.80, 31.92, 0.4768),
